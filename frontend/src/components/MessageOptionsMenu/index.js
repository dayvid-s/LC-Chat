...
const MessageOptionsMenu = ({ message, data, menuOpen, handleClose, anchorEl }) => {
  ...
  const [forwardMessageModalModalOpen, setForwardMessageModalModalOpen] = useState(false);
  ...
  const handleOpenForwardMessageModal = () => {
    setForwardMessageModalModalOpen(true);
    handleClose();
  }

  const handleCloseForwardMessageModalModal = () => {
    setForwardMessageModalModalOpen(false);
  }

  return (
    <>
      <ForwardMessageModal
        open={forwardMessageModalModalOpen}
        onClose={handleCloseForwardMessageModalModal}
      ...
      >
        ...
        <MenuItem onClick={handleOpenForwardMessageModal}>
          Encaminhar mensagem
        </MenuItem>
